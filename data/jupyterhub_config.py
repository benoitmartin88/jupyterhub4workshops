...
# c.Spawner.notebook_dir = '/srv/jupyterhub/user_data/{username}'
...
def my_hook(spawner):
    username = spawner.user.name
    admin = spawner.user.admin # True or False
    check_call(['/srv/jupyterhub/pre_spawn_hook.sh', username, str(admin)])
...
# c.Authenticator.admin_users = set('benoit')
c.Authenticator.admin_users = {'benoit'}
